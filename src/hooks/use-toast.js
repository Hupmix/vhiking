...
export const reducer = (state, action) => {
    switch (action.type) {
        ...
        case "DISMISS_TOAST": {
            ...
            return Object.assign(Object.assign({}, state), { toasts: state.toasts.map((t) => toastId === undefined || t.id === toastId ? Object.assign(Object.assign({}, t), { open: false }) : t) });
        }
        case "REMOVE_TOAST":
            if (!action.toastId)
...
function toast(_a) {
    var props = __rest(_a, []);
    const id = genId();
    const update = (props) => dispatch({ type: "UPDATE_TOAST", toast: Object.assign(Object.assign({}, props), { id }) });
